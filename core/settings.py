...
# else:
U2F_APPID="https://pos-system-app.vercel.app"    #URL For U2F
FIDO_SERVER_ID=u"pos-system-app.vercel.app"      # Server rp id for FIDO2, it the full domain of your project
